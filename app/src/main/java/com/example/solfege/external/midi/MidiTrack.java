...
package com.example.solfege.external.midi;
...
import com.example.solfege.external.midi.event.MidiEvent;
import com.example.solfege.external.midi.event.NoteOn;
import com.example.solfege.external.midi.event.meta.EndOfTrack;
import com.example.solfege.external.midi.event.meta.Tempo;
import com.example.solfege.external.midi.event.meta.TimeSignature;
import com.example.solfege.external.midi.util.MidiUtil;
import com.example.solfege.external.midi.util.VariableLengthInt;
